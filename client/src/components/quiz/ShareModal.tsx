...
export default function ShareModal() {
  ...
  return (
    <div className="w-full max-w-2xl flex flex-col items-center gap-6 sm:gap-8">
      ...
      {/* Main Card */}
      <div className="w-full bg-[#111C16] border border-[#1f3329] rounded-2xl p-5 sm:p-8 shadow-2xl mt-2 sm:mt-4">
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-4 bg-[#0D1511] border border-[#1f3329] p-2 rounded-md">
          ...
          />
          <button className="w-full md:w-auto bg-[#B28228] hover:bg-[#976E22] text-[#0D1511] text-[11px] font-bold uppercase tracking-widest px-8 py-3.5 rounded-[3px] transition-colors whitespace-nowrap">
            Copy Link
          </button>
        </div>
        ...
        <div className="relative flex items-center py-8">
          <div className="grow border-t border-[#1f3329]"></div>
          <span className="shrink-0 mx-4 text-[10px] tracking-widest uppercase text-[#8A9C94] font-bold">OR</span>
          <div className="grow border-t border-[#1f3329]"></div>
        </div>
        ...
        <div className="flex flex-col items-center gap-8 pb-4">
          ...
          <button className="flex items-center gap-2 text-[#8A9C94] hover:text-[#C69B35] transition-colors text-[11px] font-bold uppercase tracking-widest">
            <Download size={14} />
            Download QR Code
          </button>
        </div>
      ...
      <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 px-2 sm:px-4 mt-2">
        <div className="flex flex-col gap-3 sm:gap-4">
          <Link to="/" className="flex items-center gap-2 text-[#8A9C94] hover:text-[#F2EBD9] transition-colors text-[11px] font-bold uppercase tracking-widest">
            <ArrowLeft size={16} />
            Back to Editor
          </Link>
          <Link to="/stats/1" className="flex items-center gap-2 text-[#8A9C94] hover:text-[#F2EBD9] transition-colors text-[11px] font-bold uppercase tracking-widest">
            View Quiz Stats
            <BarChart2 size={16} />
          </Link>
        </div>

        <div className="flex items-center gap-3 bg-[#111C16] border border-[#1f3329] px-4 py-3 rounded-md w-full sm:w-auto">
