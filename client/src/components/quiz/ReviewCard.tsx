    ...
    return (
        <div className="w-full bg-[#111C16] border border-[#1f3329] rounded-xl p-6 md:p-8 flex flex-col gap-6 relative">
            <div className="flex items-start justify-between mb-2">
                ...
                <div className={`px-2 py-1 flex items-center justify-center rounded-[3px] text-[9px] font-bold tracking-widest uppercase ${isCorrect ? 'bg-[#15221c] text-[#8A9C94] border border-[#1f3329]' : 'bg-[#e57a7a]/10 text-[#e57a7a] border border-[#e57a7a]/20'
                    }`}>
