...
export default function Navbar() {
    return (
        <nav className="w-full h-24 px-6 md:px-12 flex items-center justify-between border-b border-transparent bg-background/80 backdrop-blur-md sticky top-0 z-50">
            ...
            {/* Utility actions and auth links */}
            <div className="flex items-center gap-6">
                ...
                <Link to="/register"
                className="bg-primary hover:bg-primary-hover text-primary-foreground text-[11px] font-bold uppercase tracking-[0.15em] px-6 py-3 rounded-[3px] transition-colors cursor-pointer">
                    Get Started
                </Link>
            </div>
