        ...
        <div className="flex items-center gap-1.5 text-primary font-bold tracking-wider order-2 sm:order-3 shrink-0">
          ...
          <span className="text-xs sm:text-sm">00:45:00</span>
            ...
            <footer className="w-full px-6 md:px-12 py-6 flex items-center justify-between bg-muted border-t border-border">
                ...
                <button className="flex items-center gap-3 bg-primary hover:bg-primary-hover text-background text-[11px] font-bold uppercase tracking-[0.15em] px-8 py-3.5 rounded-[3px] transition-colors shadow-lg">
                    Next Question
                    <ArrowRight size={16} />
                </button>
