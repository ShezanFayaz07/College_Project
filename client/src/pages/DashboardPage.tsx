    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/30">
            ...
            <header className="w-full px-6 md:px-12 py-6 flex items-center justify-between border-b border-border bg-background z-10 sticky top-0">
                ...
                <div className="flex items-center justify-center w-10 h-10 rounded-full border border-border bg-card text-primary cursor-pointer hover:bg-muted transition-colors shadow-sm">
                    <Link to="/dashboard">
                        <User size={18} />
                    </Link>
                </div>
