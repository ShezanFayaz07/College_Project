  ...
  return (
    <div className="flex-1 w-full flex flex-col max-w-350 mx-auto px-4 md:px-8 lg:px-12 py-8 md:py-10 pb-24 md:pb-28">
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-muted border border-border rounded-lg hidden sm:block">
                    <FileText size={20} className={fileStatus === 'ready' ? "text-green-500" : "text-primary"} />
                  </div>
                  <div>
                    <h4 className="text-foreground text-sm font-bold mb-1 break-all pr-4">lecture_notes.pdf</h4>
      ...
      <div className="fixed bottom-0 right-0 z-20 w-full bg-background/90 backdrop-blur-md border-t border-border flex items-center justify-end gap-3 px-4 py-3 sm:px-6 sm:py-4 md:px-12 md:py-5">
        <Link
          to="/create/edit"
          className="flex items-center gap-2 bg-primary hover:bg-primary-hover text-primary-foreground font-bold uppercase rounded-sm transition-all shadow-lg active:scale-95 whitespace-nowrap
