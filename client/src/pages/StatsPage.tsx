    ...
    return (
        <div className="min-h-screen bg-[#0D1511] text-[#F2EBD9] flex flex-col font-sans">
            ...
            <main className="flex-1 w-full max-w-6xl mx-auto px-6 py-12 flex flex-col gap-12">
                ...
                <div>
                    <h1 className="text-4xl md:text-5xl font-serif text-[#F2EBD9] mb-4">Quiz <span className="italic text-[#C69B35]">Stats</span></h1>
                    <p className="text-[#8A9C94] text-sm md:text-base">Modern Philosophy</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#111C16] border border-[#1f3329] p-6 rounded-xl flex items-center gap-6 ">
